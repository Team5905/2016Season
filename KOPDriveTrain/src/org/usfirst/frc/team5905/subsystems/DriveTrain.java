...
public class DriveTrain extends Subsystem {
	...
	public void moveWithJoysticks() {
		double leftPower = Robot.oi.gamepad.getRawAxis(1) * LeftCalibration;
		double rightPower = Robot.oi.gamepad.getRawAxis(5) * RightCalibration;
		
		robotDrive41.tankDrive(leftPower, rightPower, true);
	}
